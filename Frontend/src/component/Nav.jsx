    ...
    return (
        <div className='w-full h-[70px] fixed top-0 px-5 py-2 flex items-center justify-between bg-[#00000047] z-10'>
            ...
            <div className='w-[30%] lg:flex items-center justify-center gap-4 hidden'>
                ...
                text-[20px] border-2 bg-black border-white cursor-pointer 'onClick={() => setShow(prev => !prev)}>
                ...
                {show && <div className='absolute top-[110%] right-[15%] flex 
            items-center flex-col justify-center gap-2 text-[16px] rounded-md
            bg-[white] ps-[15px] py-[10px] border-[2px] border-black hover:border-white hover:text-white
            ...
            <div className={`fixed top-0 left-0 w-[100vw] h-[100vh] bg-[#000000d6] flex items-center justify-center flex-col gap-5 z-10 lg:hidden ${showHam ? "translate-x-[0] transition duration-600" : "translate-x-[-100%] transition duration-600 "}`}>
                ...
                {userData?.role === "educator" && <div className='w-[200px] h-[65px] flex items-center justify-center  border-2 border-white text-white bg-black rounded-xl text-lg font-light cursor-pointer'
                ...
                {!userData ? <span className='w-[200px] h-[65px] flex items-center justify-center  border-2 border-white text-white bg-black rounded-xl text-lg font-light cursor-pointer' onClick={() => navigate("/login")}>
                    Login
                </span> :

                    <span className='w-[200px] h-[65px] flex items-center justify-center  border-2 border-white text-white bg-black rounded-xl text-lg font-light cursor-pointer' onClick={handleLogOut}>
                        LogOut
                    </span>
                }
            </div>
