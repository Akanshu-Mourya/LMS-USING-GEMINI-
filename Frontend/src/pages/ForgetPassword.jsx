      ...
      {step == 1 && <div className='bg-white shadow-md rounded-xl p-8 max-w-md w-full'>
        ...
        <form className='space-y-4' onSubmit={(e) => { e.preventDefault() }}>
          <div>
            ...
            focus:ring-2 focus:ring-[black]'placeholder='you@gmail.com' required onChange={(e) => setEmail(e.target.value)} value={email} />
          </div>
      ...
      {step == 2 && <div className='bg-white shadow-md rounded-xl p-8 max-w-md w-full'>
        ...
        <form className='space-y-4' onSubmit={(e) => e.preventDefault()}>
          <div>
            ...
            <input type="text" id="otp" className='mt-1 
            w-full px-4 py-2 border border-gray-300
            rounded-md shadow-sm focus:outline-none 
            focus:ring-2 focus:ring-[black]'placeholder='* * * *' required onChange={(e) => setOtp(e.target.value)} value={otp} />
          </div>
          <button className='w-full bg-[black] hover:bg-[#4b4b4b] text-white py-2 px-4 rounded-md font-medium cursor-pointer' disabled={loading} onClick={verifyOtp}>{loading ? <ClipLoader size={30} color='white' /> : "Varify OTP"}</button>
        </form>
        <div className='text-sm text-center mt-4 cursor-pointer' onClick={() => navigate("/login")}>Back to Login</div>
      </div>}
      ...
      {step == 3 && <div className='bg-white shadow-md rounded-xl p-8 max-w-md w-full'>
        ...
        <form className='space-y-4' onSubmit={(e) => e.preventDefault()}>
          <div>
            ...
            <input type="text" id="password" className='mt-1 
            w-full px-4 py-2 border border-gray-300
            rounded-md shadow-sm focus:outline-none 
          ...
          <div>
            ...
            <input type="text" id="conpassword" className='mt-1 
            w-full px-4 py-2 border border-gray-300
            rounded-md shadow-sm focus:outline-none 
            focus:ring-2 focus:ring-[black]'placeholder='*************' required onChange={(e) => setConPassword(e.target.value)} value={conPassword} />
          </div>
