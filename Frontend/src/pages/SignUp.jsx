      ...
      <form className='w-[90%] md:w-200 h-150 bg-[white] shadow-xl rounded-2xl flex' onSubmit={(e) => e.preventDefault()}>
        ...
        <div className='md:w-[50%] w-[100%] h-[100%] flex flex-col items-center justify-center gap-3'>
          <div>
            ...
            <h1 className='text-[#999797] text-[18px]'>Create your account</h1>
          </div>
          ...
          <div className='flex md:w-[50%] w-[70%] items-center justify-center gap-x-4 mt-2'>
            <span
          ...
          <div className='text-[#6f6f6f]'>Already have an account?
            <span className='underline underline-offset-1 text-[black] cursor-pointer m-1' onClick={() => navigate("/login")}>Login</span>
          </div>
        </div>
        {/* right div */}
